---
date: "2016-06-20T23:46:37.121Z"
title: Seesaw
subtitle: Track who owes who what
splashImage: "./featured-image.jpg"
type: Case Study
...
<section>
<img alt="Money app user survey" src="./user-research@2x.jpg" class="full">
</section>
...
![Money app empathy maps](./empathy-map-web.png)
...
<section>
<img alt="sketches" src="./sketches.jpg" class="full">
</section>
...
![adding a new one-to-one event](./flow-new-event-phone.gif)

##### Jack went shopping and picked up some cleaning stuff for my room. I owe him £1.25.

### New event in group

![adding a bill to a group](./flow-new-group-event.gif)
...
<section>
<img alt="sketches" src="./flow-login.png" class="full">
</section>

##### First-time signup for new user from App Store download.

<section>
<img alt="sketches" src="./flow-121.png" class="full">
</section>
...
![Debtbot implemented in-app](./debtbot.png)
...
![Debtbot – your financial sidekick](./sidekicks.jpg)
...
![Debtbot – your financial sidekick](./debtbot-polished.png)
...
![money-owed dynamics](./doodles-web.png)
...
<img alt="sketches" src="./logo.png" class="wide">
</section>

![Icon in Context](./icon-context.png)
